        ...
        <div class="index">
            ...
            <div class="others">
                <ul class="nav">
                    ...
                    <?php if(isset($_GET['route'])&&($_GET['route']!='product/list')&&($_GET['route']!='account/new')){ ?> <li class="line">|</li> <?php } ?>
                    <li class="text <?php if(isset($_GET['route'])&&($_GET['route']=='account/new')){ echo 'thispage'; } ?>"><a href="/index.php?route=account/new">我要寄卖</a></li>
                    <?php if(isset($_GET['route'])&&($_GET['route']!='account/new')&&($_GET['route']!='product/identify')){ ?> <li class="line">|</li> <?php } ?>
                    <li class="text <?php if(isset($_GET['route'])&&($_GET['route']=='product/identify')){ echo 'thispage'; } ?>"><a href="/index.php?route=product/identify">我要鉴定</a></li>
