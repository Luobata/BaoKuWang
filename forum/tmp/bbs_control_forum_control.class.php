...
class forum_control extends common_control {
	...
	public function on_index() {
		...
		if(empty($digest)) {
			$pages = misc::pages("http://localhost/forum/?forum-index-fid-$fid$digestadd$typeidadd.htm", $threads, $page, $pagesize);
		} else {
			$pages = misc::simple_pages("http://localhost/forum/?forum-index-fid-$fid$digestadd$typeidadd.htm", count($threadlist), $page, $pagesize);
		}
