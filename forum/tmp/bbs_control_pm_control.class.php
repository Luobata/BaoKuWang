...
!defined('FRAMEWORK_PATH') && exit('FRAMEWORK_PATH not defined.');
	include 'D:/WampServer/wamp/www/forum/tmp/control_common_control.class.php';
...
class pm_control extends common_control {
	...
	public function on_ajaxlist() {
		...
		$page = $totalpage;
		$pages = misc::pages("http://localhost/forum/?pm-ajaxlist-uid-$uid1.htm", $count, $page, $pagesize);
