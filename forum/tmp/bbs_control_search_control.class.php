...
class search_control extends common_control {
	...
	public function on_index() {
		...
		$toplist = array();
		$pages = misc::simple_pages("http://localhost/forum/?search-index-fid-$fid-orderby-$orderby-daterage-$daterange-keyword-$keyword_url.htm", count($threadlist), $page, $pagesize);
