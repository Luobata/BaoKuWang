...
<ul class="left_menu">
	...
	<div class="div">
		<div class="header">我的发帖</div>
		<div class="body">
			<?php if(!empty($mypostlist)) { foreach($mypostlist as &$post) {?>
			<div style="margin-top: 4px; line-height: 2;">
				<span class="grey"><a href="http://localhost/forum/?forum-index-fid-<?php echo isset($post['fid']) ? $post['fid'] : '';?>.htm" target="_blank">【<?php echo isset($post['forumname']) ? $post['forumname'] : '';?>】</a></span><a href="http://localhost/forum/?thread-index-fid-<?php echo isset($post['fid']) ? $post['fid'] : '';?>-tid-<?php echo isset($post['tid']) ? $post['tid'] : '';?>-page-<?php echo isset($post['post']['page']) ? $post['post']['page'] : '';?>.htm" target="_blank"><?php echo isset($post['thread']['subject']) ? $post['thread']['subject'] : '';?></a>
				<span class="tiny grey">- <?php echo isset($post['thread']['dateline_fmt']) ? $post['thread']['dateline_fmt'] : '';?></span>
