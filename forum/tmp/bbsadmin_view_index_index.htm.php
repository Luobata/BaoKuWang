...
<frameset rows="35,*" frameborder="1" border="1" framespacing="0">
	<frame name="top" scrolling="no" src="http://localhost/forum/admin/?index-top.htm" frameborder="1" border="1" />
	<frameset cols="160,*" frameborder="0" border="0" framespacing="0">
		<frame name="frame_menu" scrolling="no" src="http://localhost/forum/admin/?index-menu.htm" frameborder="0" border="1"/>
		<frame name="main" scrolling="yes" src="http://localhost/forum/admin/?index-main.htm" frameborder="0" border="0" />
	</frameset>
</frameset>
