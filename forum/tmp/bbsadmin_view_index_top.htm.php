	...
	<table cellpadding="0" cellspacing="0" width="100%">
		<tr>
			...
			<td class="center" style="text-align: left;" id="topmenu">
				...
				<a href="http://localhost/forum/admin/?index-menu-type-conf.htm" target="frame_menu" class="a_conf">设置</a>				<span class="sep"></span>
				<a href="http://localhost/forum/admin/?index-menu-type-forum.htm" target="frame_menu" class="a_forum">版块</a>			<span class="sep"></span>
				<a href="http://localhost/forum/admin/?index-menu-type-post.htm" target="frame_menu" class="a_post">帖子</a>				<span class="sep"></span>
				<a href="http://localhost/forum/admin/?index-menu-type-user.htm" target="frame_menu" class="a_user">用户</a>				<span class="sep"></span>
	<?php if(!IN_SAE) { ?>	<a href="http://localhost/forum/admin/?index-menu-type-log.htm" target="frame_menu" class="a_log">日志</a>				<span class="sep"></span>	<?php } ?>
				<a href="http://localhost/forum/admin/?index-menu-type-other.htm" target="frame_menu" class="a_other">其他</a>			<span class="sep"></span>
				<?php } ?>
				<?php if($_group['groupid'] > 0 && $_group['groupid'] < 6) { ?>
				<a href="http://localhost/forum/admin/?index-menu-type-mod.htm" target="frame_menu" class="a_mod">版主管理</a>			<span class="sep"></span>
				<?php } ?>
				<?php if($_group['groupid'] == 1) { ?>
				<a href="http://localhost/forum/admin/?index-menu-type-plugin.htm" target="frame_menu" class="a_plugin">插件</a>			<span class="sep"></span>
				<?php } ?>
			...
			<td class="right" width="160">
				...
				<?php echo isset($_user['username']) ? $_user['username'] : '';?> (<?php echo isset($_group['name']) ? $_group['name'] : '';?>), <a href="http://localhost/forum/admin/?index-logout.htm" target="_top">退出</a></span>
			</td>
		</tr>
	</table>
</div>
...
top.frame_menu.location = 'http://localhost/forum/admin/?index-menu-type-mod.htm';
top.main.location = 'http://localhost/forum/admin/?mod-setforum.htm';
<?php } ?>
</script>
