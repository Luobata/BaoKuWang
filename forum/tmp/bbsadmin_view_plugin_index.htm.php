		...
		<div class="list">
			...
			<table class="table">
				...
				<tr valign="top" plugindir="<?php echo isset($dir) ? $dir : '';?>">
					<td width="54"><a href="http://localhost/forum/admin/?plugin-read-dir-<?php echo isset($dir) ? $dir : '';?>.htm"><img src="<?php echo isset($pconf['icon_url']) ? $pconf['icon_url'] : '';?>" width="54" height="54" /></a></td>
					<td width="140">
						<a href="http://localhost/forum/admin/?plugin-read-dir-<?php echo isset($dir) ? $dir : '';?>.htm"><b><?php echo isset($pconf['name']) ? $pconf['name'] : '';?> </b></a>v<?php echo isset($pconf['version']) ? $pconf['version'] : '';?>
			...
			<table class="table">
				...
				<tr valign="top" plugindir="<?php echo isset($dir) ? $dir : '';?>">
					...
					<td width="200">
						...
						<a type="button" class="button smallgrey" onclick="if(window.confirm('删除操作不可逆！确定删除?'))window.location='http://localhost/forum/admin/?plugin-unstall-dir-<?php echo isset($dir) ? $dir : '';?>.htm';return false;" value="删除" href="javascript:void(0)" role="button"><span>删除</span></a>
					
						<?php if(!empty($pconf['have_setting'])) { ?>
						<a type="button" value="设置" class="button smallblue setting" onclick="window.location='http://localhost/forum/admin/?plugin-setting-dir-<?php echo isset($dir) ? $dir : '';?>.htm';return false;" href="javascript:void(0)" role="button"><span>设置</span></a>
						<?php } ?>
					</td>
				</tr>
				<?php }}?>
			...
			<table class="table">
				...
				<tr valign="top" plugindir="<?php echo isset($dir) ? $dir : '';?>">
					<td width="54"><a href="http://localhost/forum/admin/?plugin-read-dir-<?php echo isset($dir) ? $dir : '';?>.htm"><img src="<?php echo isset($pconf['icon_url']) ? $pconf['icon_url'] : '';?>" width="54" height="54" /></a></td>
					<td width="140">
						<a href="http://localhost/forum/admin/?plugin-read-dir-<?php echo isset($dir) ? $dir : '';?>.htm"><b><?php echo isset($pconf['name']) ? $pconf['name'] : '';?> </b>v<?php echo isset($pconf['version']) ? $pconf['version'] : '';?></a>
						<?php if($pconf['have_new_version']) { ?><span class="red small bold">(NEW! v<a href="http://localhost/forum/admin/?plugin-upgrade-dir-<?php echo isset($dir) ? $dir : '';?>.htm" target="_blank"><?php echo isset($pconf['official_version']) ? $pconf['official_version'] : '';?></a>)</span><?php } ?>
						<br /><span class="small"><?php echo isset($dir) ? $dir : '';?></span>
						<br /><img src="http://localhost/forum/admin/view/image/star_<?php echo isset($pconf['stars']) ? $pconf['stars'] : '';?>.gif" width="63" height="11" align="middle" />
					</td>
					<td>
					...
					<td width="200">
						...
						<a type="button" class="button smallgrey" onclick="if(window.confirm('确定删除?'))window.location='http://localhost/forum/admin/?plugin-unstall-dir-<?php echo isset($dir) ? $dir : '';?>.htm';return false;" value="删除" href="javascript:void(0)" role="button"><span>删除</span></a>
					</td>
				</tr>
				<?php }}?>
			</table>
