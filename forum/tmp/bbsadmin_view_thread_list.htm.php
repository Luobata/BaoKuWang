...
<div class="width">
	<form action="http://localhost/forum/admin/?thread-list.htm" method="post" id="srchform">
...
<?php if($threadlist) { ?>
	<form action="http://localhost/forum/admin/?thread-replace.htm" method="post" id="resultform">
		<input type="hidden" name="FORM_HASH" value="<?php echo FORM_HASH;?>" />
...
$('#mdelete').click(function() {
	$('#resultform').attr('action', 'http://localhost/forum/admin/?thread-delete.htm');
	$('#resultform').submit();
	return false;
});

$('#mreplace').click(function() {
	$('#resultform').attr('action', 'http://localhost/forum/admin/?thread-replace.htm');
	$('#resultform').submit();
	return false;
});
</script>
